...
class dcs_account_common_report(osv.osv_memory):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        res = super(dcs_account_common_report, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=False)
    ...
    _defaults = {
            ...
            'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'dcs.account.common.report',context=c),
...
class dcs_accounting_report(osv.osv_memory):
    ...
    _description = "DCS Accounting Report"
    ...
    def check_report_test2(self, cr, uid, ids, context=None):
        if context is None:
            context = {}
        res = super(dcs_accounting_report, self).check_report_test2(cr, uid, ids, context=context)
        data = {}
