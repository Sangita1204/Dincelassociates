...
class general_ledger_dcs(report_sxw.rml_parse, common_report_header1):
	_name = 'report.account.account.general_ledger_dcs'
	inherit = 'report.account.general.ledger'#:account.report.general.ledger'
	def __init__(self, cr, uid, name, context=None):
		if context is None:
			context = {}
		super(general_ledger_dcs, self).__init__(cr, uid, name, context=context)
		self.query = ""
	...
	def get_children_accounts(self, account):
		...
		_logger.error("get_children_accountsget_children_accounts-1" + str(account))
...
class report_general_ledger_dcs(osv.AbstractModel):
	_name = 'report.account.report_general_ledger_dcs'
	_inherit = 'report.abstract_report'
	_template = 'dincelaccount.report_general_ledger_dcs'
	_wrapped_report_class = general_ledger_dcs
